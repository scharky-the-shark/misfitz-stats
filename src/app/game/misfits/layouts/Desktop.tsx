...
<div className="space-y-10">
  ...
  <AnimatePresence mode="wait">
    ...
    <motion.section
      ...
      className="rounded-3xl border border-neutral-800 bg-neutral-900/40 p-8"
    >
      ...
      <div className="grid gap-10 xl:grid-cols-[420px_1fr]">
        ...
        <div className="flex items-center justify-center">
          ...
          <motion.div
            ...
            exit={{ opacity: 0, x: 25 }}
            transition={{ duration: 0.25 }}
            className="relative h-[260px] w-[260px] md:h-[340px] md:w-[340px] xl:h-[420px] xl:w-[420px]"
          >
{selected.status === "teaser" ? (
  ...
  />
        ...
        <div className="flex flex-col">
          ...
          <section className="mt-10 rounded-2xl border border-neutral-800 bg-neutral-950/70 p-6">
