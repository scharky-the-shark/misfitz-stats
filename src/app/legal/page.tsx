export const metadata = {
  ...
  description:
    "Legal information regarding Misfitz Stats, intellectual property, content ownership, liability, and contact details.",
};
...
<aside className="sticky top-28 h-fit self-start">
    ...
    <nav className="flex flex-col gap-5 text-sm">
      ...
      <a href="#third-party" className="hover:text-white">
        03 Third-Party Services
      </a>

      <a href="#ip" className="hover:text-white">
      ...
      <a href="#removal" className="hover:text-white">
        06 Removal Requests
      </a>
