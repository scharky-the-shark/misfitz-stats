...
<section className="relative mx-auto flex max-w-7xl flex-col items-center px-6 pt-20 text-center">
  ...
  <p className="mt-6 max-w-3xl text-lg text-white/70">
    Install the Misfitz Statz Community Bot to unlock server
    leaderboards, player verification and advanced community
    statistics.
  </p>

  <div className="mt-8 flex flex-wrap justify-center gap-3">
    <span className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm">Share Statistics</span>
    <span className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm">Secure Verification</span>
    <span className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm">Server Leaderboards</span>
...
<section className="relative mx-auto max-w-7xl px-6 py-24">
  ...
  <div className="grid gap-6 md:grid-cols-2">
    ...
    <div className="rounded-3xl border border-white/10 bg-white/5 p-7 backdrop-blur-xl">
      ...
      <p className="text-white/70">
        Allows that all server members experience the same quality no matter the activity on your server 
      </p>
    </div>
