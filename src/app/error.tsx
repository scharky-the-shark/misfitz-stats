...
<main className="fixed inset-0 z-[9999] overflow-hidden bg-[#0b1220] text-white">
  ...
  <section className="relative z-10 flex h-screen flex-col items-center text-center">
    ...
    <h1 className="mt-8 text-6xl font-black uppercase tracking-wider md:text-8xl">ERROR 500</h1>
    <h2 className="mt-4 bg-gradient-to-r from-[#7CFF00] to-[#00D9FF] bg-clip-text text-2xl font-bold uppercase text-transparent md:text-4xl">Internal error</h2>
    <p className="mt-6 max-w-2xl text-white/70 text-lg">The relic you are searching exploded.</p>
    <p className="mt-2 text-white/50">Zero may have tricked you</p>
